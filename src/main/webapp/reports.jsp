                        ...
                        <div class="dashboard_grid_container">
                            ...
                            <div class="dash_grid_items">
                                ...
                                <button onclick="window.print()">print report</button>
                                    <div class="container ">
                                        <div class=" common-grid print-container "
                                            style=" --grid-template:auto auto auto auto auto auto">
                            ...
                            <div class=" title ">
                                <h5><span>Actions</span></h5>
                                            ...
                                            <% String select_query="SELECT * FROM sales" ; Statement
                                                ...
                                                resultSet=statement.executeQuery(select_query); while(resultSet.next()){
                                                int product_id=resultSet.getInt("product_id"); String
                                                ...
                                                selling=resultSet.getInt("price_sold"); String
                                                date_sold=resultSet.getString("date_sold"); int
                                                user_id=resultSet.getInt("sold_by"); String user_name=null; String
